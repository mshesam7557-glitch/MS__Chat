...
async def rtc_config(username: str = "", token: str = ""):
    ...
    if username and token and verify_token(username, token):
        ...
        return {"success": True, "ice_servers": servers}
    return {"success": False, "ice_servers": servers}
    ...
    try:
        ...
        while True:
            ...
            if action == "call-offer":
                ...
                mode = data.get("mode") if data.get("mode") in ("audio", "video") else "audio"
